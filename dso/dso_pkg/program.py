...
import numpy as np
from dso_pkg.library import Token, PlaceholderConstant, Polynomial
from dso_pkg.const import make_const_optimizer
from dso_pkg.utils import cached_property
import dso_pkg.utils as U
...
class Program:
    ...
    def set_execute(cls, protected):
        ...
        try:
            from dso_pkg.execute import cython_execute
            execute_function = cython_execute
            Program.have_cython = True
        except ImportError:
            from dso_pkg.execute import python_execute
